...
export const blackPieces = [
  ...
  new Queen(PieceSide.black, { x: 1, y: 0 }),
  new Queen(PieceSide.black, { x: 1, y: 1 }),
  new Queen(PieceSide.black, { x: 1, y: 2 }),
  new Queen(PieceSide.black, { x: 1, y: 3 }),
  new Queen(PieceSide.black, { x: 1, y: 4 }),
  new Queen(PieceSide.black, { x: 1, y: 5 }),
  new Queen(PieceSide.black, { x: 1, y: 6 }),
  new Queen(PieceSide.black, { x: 1, y: 7 }),
]
...
export const whitePieces = [
  ...
  new Queen(PieceSide.white, { x: 6, y: 0 }),
  new Queen(PieceSide.white, { x: 6, y: 1 }),
  new Queen(PieceSide.white, { x: 6, y: 2 }),
  new Queen(PieceSide.white, { x: 6, y: 3 }),
  new Queen(PieceSide.white, { x: 6, y: 4 }),
  new Queen(PieceSide.white, { x: 6, y: 5 }),
  new Queen(PieceSide.white, { x: 6, y: 6 }),
  new Queen(PieceSide.white, { x: 6, y: 7 }),
]
